          ...
          >
            <div className=" h-[13%] px-10 py-14">
              <div className="relative card">
                <h1 className="text-[32px] text-cyan-800 font-medium capitalize">
                  {templateInputs.name || "Your Name"}
                </h1>
                <h1 className="text-[18px] font-light text-gray-950 capitalize">
            ...
            <div className="h-4 bg-gradient-to-r rounded-xl from-cyan-800 to-slate-50">
            </div>
            ...
            <div
              ...
              className="realtive flex justify-between w-full h-[87%] px-10"
            >
                           <div
                id="template-body-left"
                className="w-full p-5 h-full px-10"
              ></div>
              <div id="template-body-right" className="w-[80%] p-5 ml-5"></div>
