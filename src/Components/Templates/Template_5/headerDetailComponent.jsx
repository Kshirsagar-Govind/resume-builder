...
const HeaderDetailView = (header_para, details_para, section_id) => {
  ...
  if (!document.getElementById(section_id + "_parDetailElement")) {
    ...
    headerDetail.setAttribute(
      "class",
      "pb-2  text-[14px] relative capitalize text-justify text-white"
    );
...
const ChangePosition = (align, section_id) => {
  ...
  if (align == "left") {
    ...
    const ParaHeaderElement = document.getElementById(`${section_id}_ParaHeaderElement`)
    ParaHeaderElement.classList.replace('text-indigo-950','text-white')
    const parDetailElement = document.getElementById(section_id + "_parDetailElement")
    parDetailElement.classList.replace('text-indigo-950','text-white')
    resumeForm_L.appendChild(parentDiv);

  } else {
    const ParaHeaderElement = document.getElementById(`${section_id}_ParaHeaderElement`)
    ParaHeaderElement.classList.replace('text-white','text-indigo-950')
    const parDetailElement = document.getElementById(section_id + "_parDetailElement")
    parDetailElement.classList.replace('text-white','text-indigo-950')
