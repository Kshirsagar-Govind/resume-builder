...
const ListComponent = ({ section_id }) => {
  ...
  return (
    ...
    onMouseEnter={()=>HoverEffectToggle_2(`${section_id}_ListItemComponent`)}
    onMouseLeave={()=>HoverEffectToggle_2(`${section_id}_ListItemComponent`)}
    >
